 ...
 * @Filename	:	uart_comms_done_notifier.h
 * @Author		:	Derek Murray
...
#ifndef _NOTIFIER_TICK_TIMERS_H_
#define _NOTIFIER_TICK_TIMERS_H_
...
typedef struct {
	...
	volatile int uart1;
	volatile int xttc0_0;
	volatile int xttc0_1;
...
#endif // _NOTIFIER_TICK_TIMERS_H_
